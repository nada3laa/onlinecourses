...
<nav className="navbar">
      ...
      <div className="vouchers-container" style={{marginBottom:"30px"}}>
      <h2 className="vouchers-title" >Features</h2>
    </div>
        ...
        <div className="col-md-4">
          <div className="cardd">
            <div className="card-body">
              <h5 className="card-title">My Course Labs</h5>
              <p className="card-text">Any lab resources required in support of the delivery of this event will be managed by your Instructor during your class</p>
              <a href="#" className="btnn btnn-primary">Learn More</a>
            </div>
          </div>
        </div>
        <div className="col-md-4">
